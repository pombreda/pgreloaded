...
def joystick_open (index):
    """joystick_open (index) -> SDL_Joystick
...
def joystick_event_state (state):
    """joystick_event_state (state) -> int
...
def joystick_get_axis (joystick, axis):
    """joystick_get_axis (joystick, axis) -> int
...
def joystick_get_ball (joystick, ball):
    """joystick_get_ball (joystick, ball) -> int, int
...
@sdltype("SDL_JoystickGetButton", [ctypes.POINTER(SDL_Joystick), ctypes.c_uint],
         ctypes.c_ubyte)
def joystick_get_button (joystick, button):
    """joystick_get_button (joystick, button) -> bool
...
def joystick_get_hat (joystick, hat):
    """joystick_get_hat (joystick, hat) -> int
...
def joystick_num_axes (joystick):
    """joystick_num_axes (joystick) -> int
...
def joystick_num_balls (joystick):
    """joystick_num_balls (joystick) -> int
...
@sdltype("SDL_JoystickNumButtons", [ctypes.POINTER(SDL_Joystick)], ctypes.c_int)
def joystick_num_buttons (joystick):
    """joystick_num_buttons (joystick) -> int
...
def joystick_num_hats (joystick):
    """joystick_num_hats (joystick) -> int
