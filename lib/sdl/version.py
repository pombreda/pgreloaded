...
class SDL_version(ctypes.Structure):
    """SDL_version (major=0, minor=0, patch=0) -> SDL_version
...
def SDL_VERSIONNUM (major, minor, patch):
    """SDL_VERSIONNUM(major, minor, patch) -> int
...
def SDL_VERSION_ATLEAST (major, minor, patch):
    """SDL_VERSION_ATLEAST (major, minor, patch) -> bool
