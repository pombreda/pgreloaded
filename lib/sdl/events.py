...
def add_event_watch (filter, userdata=None):
    """add_event_watch (filter, userdata=None) -> None
    ...
    filter._userdata.append (val) # Preserve the userdata
...
def del_event_watch (filter, userdata=None):
    """del_event_watch (filter, userdata=None) -> None
...
def filter_events (filter, userdata=None):
    """filter_events (filter, userdata=None) -> None
...
def flush_events (mintype, maxtype):
    """flush_events (mintype, maxtype) -> None
...
@sdltype("SDL_GetEventFilter", [ctypes.POINTER(SDL_EventFilter),
                                ctypes.POINTER(ctypes.py_object)], ctypes.c_int)
def get_event_filter ():
    """get_event_filter () -> SDL_EventFilter, object
...
def set_event_filter (filter, userdata=None):
    """set_event_filter (fiter, userdata=None) -> None
...
def has_events (mintype, maxtype):
    """has_events (mintype, maxtype) -> bool
...
def peep_events (events, numevents, action, mintype, maxtype):
    """peep_events (events, numevents, action, mintype, maxtype) -> int, (SDL_Event, ...)
...
def poll_event (getevent=False):
    """poll_event (getevent=False) -> SDL_Event or bool
...
def wait_event_timeout (timeout):
    """wait_event_timeout (timeout) -> SDL_Event
