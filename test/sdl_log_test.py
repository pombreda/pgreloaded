...
class SDLLogTest (unittest.TestCase):
    ...
    def test_log_set_all_priority (self):
        self.assertEqual (log.log_get_priority \
            (log.SDL_LOG_CATEGORY_APPLICATION), log.SDL_LOG_PRIORITY_VERBOSE)
        self.assertEqual (log.log_get_priority \
            (log.SDL_LOG_CATEGORY_SYSTEM), log.SDL_LOG_PRIORITY_VERBOSE)
        log.log_set_all_priority (log.SDL_LOG_PRIORITY_WARN)
        self.assertEqual (log.log_get_priority \
            (log.SDL_LOG_CATEGORY_APPLICATION), log.SDL_LOG_PRIORITY_WARN)
        self.assertEqual (log.log_get_priority \
            (log.SDL_LOG_CATEGORY_SYSTEM), log.SDL_LOG_PRIORITY_WARN)
